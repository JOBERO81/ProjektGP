...
func (ps *PhishingServer) registerRoutes() {
	...
	router.HandleFunc("/{path:.*}/false_positive", ps.FalsePositiveHandler)
	router.HandleFunc("/false_positive", ps.FalsePositiveHandler)
...
func (ps *PhishingServer) FalsePositiveHandler(w http.ResponseWriter, r *http.Request) {
